...
const BackgroundLayerItemComponent: React.FC<BackgroundLayerItemProps> = ({
  layer,
  isVisible,
  isOnTop,
  layerColor,
  ...
  return (
    <BackgroundLayerItem $isVisible={isVisible}>
...
export default BackgroundLayerItemComponent; 