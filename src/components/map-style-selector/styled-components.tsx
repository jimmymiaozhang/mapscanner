...
export const IconButton = styled.button.withConfig({
  ...
  svg {
    ...
    height: 16px;
    color: ${props => {
      if (props.$onTop) return '#1A1A1A';
      if (props.$active) return props.theme?.textColor || '#3A414C';
      return props.theme?.subtextColor || '#6A7485';
    }};
    opacity: ${props => {
      if (props.$onTop) return '1';
